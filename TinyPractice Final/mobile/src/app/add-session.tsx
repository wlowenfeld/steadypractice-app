...
import { X, Check, Minus, Plus, Calendar, Receipt, Share2 } from 'lucide-react-native';
...
export default function AddSessionScreen() {
  ...
  const handleSave = () => {
    ...
    // Use appointment date if from an appointment, otherwise current time
    const sessionDate = appointment ? appointment.scheduledDate : new Date().toISOString();
  ...
  const handleCreateInvoice = () => {
    ...
    linkSessionsToInvoice([savedSessionId], invoiceId);
