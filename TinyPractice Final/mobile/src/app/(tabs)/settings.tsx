...
export default function SettingsScreen() {
  ...
  const handleShareApp = async () => {
    ...
    try {
      await Share.share({
        message: `I've been using TinyPractice for my practice — session notes, scheduling, invoicing for $5/mo. Data stays on your phone. Free for 5 clients: https://apps.apple.com/app/id6758564968`,
      });
    } catch {
      // User cancelled
    }
