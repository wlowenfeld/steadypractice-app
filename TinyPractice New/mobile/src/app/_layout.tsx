...
function RootLayoutNav() {
  ...
  // Crash recovery: if the app restarts while demo mode was active,
  // isDemoMode will be false (not persisted) but demo data may remain.
  // This also handles the edge case where demo mode is somehow active on mount.
  useEffect(() => {
    if (isDemoMode) {
      clearDemoData();
    }
    ...
    <NavThemeProvider value={isDark ? DarkTheme : DefaultTheme}>
      ...
      <SecurityGate>
        ...
        >
          ...
          />
          <Stack.Screen name="security-recommendations" />
